"""
Django settings for m_treat project.
...
SECRET_KEY = 'django-insecure-haij&*gz029ap)v+wdtt28fkpbq!6^7j!^o(s%87*&br0w!n68'
...
WSGI_APPLICATION = 'm_treat.wsgi.application'
